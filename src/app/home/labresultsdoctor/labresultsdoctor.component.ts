...
@Component({
  selector: 'app-labresultsdoctor',
  templateUrl: './labresultsdoctor.component.html',
  styleUrls: ['./labresultsdoctor.component.css']
})
export class LabresultsdoctorComponent implements OnInit {
